...
### Jerry ESP32-S3 开发板增强功能

- 全新设计的GIF表情动画系统，支持25fps流畅动画显示
- 支持亮色和暗色主题切换，适配不同环境光线
- 智能主题适配功能，GIF动画会根据当前主题自动切换普通版或Inversion版
- 优化的UI层级管理，确保聊天消息始终清晰可见
- 改进的启动流程，消除初始化过程中的屏幕闪烁问题
- 支持从设置中加载上次使用的主题，提供一致的用户体验
- 聊天消息支持水平居中对齐和自动换行显示
